from classes.modules.programming.github import Github
from classes.modules.programming.pastebin import Pastebin
from classes.modules.programming.replit import Replit
